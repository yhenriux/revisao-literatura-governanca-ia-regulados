# Matriz de resposta ao parecer — v1 final

| ID | Observação ou critério | Ação na v1 corrigida | Evidência | Status |
|---|---|---|---|---|
...
| M03 | APIs, hashes e logs prejudicam a fluidez | Manutenção no suplemento e no repositório | `docs/methodology/` e `suplemento/` | Atendido |
...
| M07 | Números repetidos | Abertura dos resultados sem recapitulação; ocorrências autônomas limitadas a `407=4`, `177=5`, `112=1`, `118=3`, `23=5`, `154=1` | Auditoria quantitativa | Atendido |
| M08 | Estilo defensivo | Justificativas operacionais removidas; oito construções defensivas auditadas com zero ocorrências | Auditoria de estilo | Atendido |
| M09 | Resultados são o ponto forte | Sete figuras e achados preservados; cortes restritos a repetição e recontagem visual | Seção 4 | Atendido |
| M10 | Figuras repetem o texto | Gráficos 2–6 acompanhados por orientação de leitura e interpretação, sem transcrição integral dos valores | Seção 4 e inspeção visual | Atendido |
| M11 | Falta formato de artigo científico | Arquitetura em seis seções, contribuição antecipada e progressão problema → lacuna → método → evidências → modelo | Manuscrito completo | Atendido |
...
| M15 | Rastreabilidade da correção | Redline real com 33 inserções, 33 exclusões e quatro comentários editoriais | `Governanca_Conversacional_v1_redline.docx` | Atendido |
